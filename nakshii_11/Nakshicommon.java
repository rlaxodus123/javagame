...
public class Nakshicommon extends JFrame {
	...
	private int score = 0;
	private int fishno = (int)(Math.random()*6)+nowSelected*7;
	...
	public Nakshicommon() {
		...
		fishList.add(new Fish("fish8.jpg","fish8pressed.jpg"));
		fishList.add(new Fish("fish9.jpg","fish9pressed.jpg"));
		fishList.add(new Fish("fish10.jpg","fish10pressed.jpg"));
		fishList.add(new Fish("fish11.jpg","fish11pressed.jpg"));
		fishList.add(new Fish("fish12.jpg","fish12pressed.jpg"));
		fishList.add(new Fish("fish13.jpg","fish13pressed.jpg"));
		fishList.add(new Fish("fish14.jpg","fish14pressed.jpg"));
		fishList.add(new Fish("fish15.jpg","fish15pressed.jpg"));
		fishList.add(new Fish("fish16.jpg","fish16pressed.jpg"));
		fishList.add(new Fish("fish17.jpg","fish17pressed.jpg"));
		fishList.add(new Fish("fish18.jpg","fish18pressed.jpg"));
		fishList.add(new Fish("fish19.jpg","fish19pressed.jpg"));
		fishList.add(new Fish("fish20.jpg","fish20pressed.jpg"));
		fishList.add(new Fish("fish21.jpg","fish21pressed.jpg"));
		...
		FishButton.addMouseListener(new MouseAdapter() {
					...
					public void mousePressed(MouseEvent e) {
					    ...
					    Random rand = new Random();
					        ...
					        // 새로운 위치로 버튼 이동
					        FishButton.setBounds(randomX, randomY, 100+50*nowSelected, 100+50*nowSelected);
					        score += 100;
					        FinalScore();
	...
	public void fishchange() {
		...
		fishno = (int)(Math.random()*7)+nowSelected*7;
		FishButton.setIcon(fishhide);
